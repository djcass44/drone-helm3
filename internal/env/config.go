...
type Config struct {
	...
	ClientCertificate  string   `envconfig:"client_certificate_data"` // Certificate to use when authenticating to the Kubernetes API
	ClientKey          string   `envconfig:"client_key_data"`         // Key to use when authentication to the Kubernetes API
